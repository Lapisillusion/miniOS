/*
 * arch/x86_64/kernel/idt.c — Interrupt Descriptor Table management
 */
...
/* Exception stubs  (isr_handlers.s) */
...
void idt_init(void)
{
    ...
    /* Populate exception stubs (vectors 0 – 31) */
    ...
    /* Populate IRQ stubs (vectors 32 – 47) */
